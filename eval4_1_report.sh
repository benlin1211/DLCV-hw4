...
# bash eval4_1_report.sh './hw4_data/hotdog/transforms_val.json' './output_p1/'
# bash eval4_1_report.sh './hw4_data_test/hotdog/transforms_test.json' './output_p1/'
#
...
python DirectVoxGO/run_eval.py --config ./train4_1_config_report3.py --json_dir $1 --output_dir $2  --render_val --render_only 
